    ...
    <div>
          ...
          {monthlyIncome.map((income, idx) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-xl font-bold text-green-600 dark:text-green-400 mt-2">₹{income.toLocaleString()}</p>
                {clickable && income > 0 && (
      ...
      {selectedMonth !== null && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold">Daily Income – {monthNames[selectedMonth]} {selectedYear}</h2>
          ...
          {dailyIncome.length === 0 || dailyIncome.every(d => d.revenue === 0) ? (
            ...
            <ResponsiveContainer width="100%" height={400}>
              <BarChart data={dailyIncome} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                ...
                <YAxis label={{ value: 'Revenue (₹)', angle: -90, position: 'insideLeft' }} stroke="#9CA3AF" />
